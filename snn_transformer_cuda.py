...
os.environ["SNN_TRAIN_FILE"] = "C:/Users/abias/Coding_GPT4_Data/Data/GPT_4_Coding.json"
print(f"SNN_TRAIN_FILE environment variable set to: {os.environ['SNN_TRAIN_FILE']}")
# ----------------------------------------------------------------------------
...
def run_training(model: Model, training_data: TrainingData, steps: int = 1000, prompt: Optional[str] = None) -> None:
    ...
    for t in range(steps):
        ...
        if t % 50 == 0:  # reduced frequency from 10000 for shorter training
            validation_loss = 0.0
...
if __name__ == '__main__':
    ...
    run_training(model, data, steps=1000, prompt="Say hello to the world") # validation prompt here